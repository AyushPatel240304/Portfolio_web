...
// Project modal functionality - open only when "Portfolio" page is active
...
for (let i = 0; i < projectItems.length; i++) {
  projectItems[i].addEventListener("click", function () {
    ...
    // Check if the active page is portfolio before opening the modal
    if (activePage && activePage.dataset.page === "portfolio") {
      ...
      modalText.innerHTML = projectCategory;
...
// Update active state for the selected page and nav link
